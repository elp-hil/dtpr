...
\label{ch:annex:sec:aircoilScript}
\begin{figure}[H]
       \centerline{ \includegraphics[width=1.1\linewidth]{graphics/screenshots/airCoilScriptSmall.png}
    }
